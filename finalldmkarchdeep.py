...
with tf.device('/device:GPU:1'):
    ...
    x1conv1 = Conv2D(80, (1,1), padding = 'same', kernel_initializer = 'he_normal')(x1se)
    ...
    x2conv1 = Conv2D(128, (1,1), padding = 'same', kernel_initializer = 'he_normal')(x2se)
...
#with tf.device('/device:GPU:2'):   
    ...
    x3conv1 = Conv2D(192, (1,1), padding = 'same', kernel_initializer = 'he_normal')(x3se)
    ...
    x4conv1 = Conv2D(384, (1,1), padding = 'same', kernel_initializer = 'he_normal')(x4se)
...
callbacks = [
    ...
    ModelCheckpoint("val_loss__final_ldmk_deep_checkpoint.h5", monitor='val_loss', verbose=1, save_best_only=True, mode='auto'),
...
model.save('final_ldmk_deep_model.h5')
...
plt.savefig('final_ldmk_deep_loss.png')

plt.figure(1)
plt.plot(history.history['lr'])
plt.title('Learning Rate')
plt.xlabel('epoch')
plt.savefig('final_ldmk_deep_lr.png')
...
plt.savefig('final_ldmk_deep_metric.png')
