...
callbacks = [
    ...
    ModelCheckpoint("resunet9_attention_checkpoint.h5", monitor='val_loss', verbose=1, save_best_only=True, mode='auto'),
...
model.save('resunet9_atention.h5')
...
plt.savefig('dice_coef_attention.png')
...
plt.savefig('jaccard_coef_attention.png')

plt.figure(3)
plt.plot(history.history['lr'])
plt.title('Learning Rate')
plt.xlabel('epoch')
plt.savefig('lr_attention.png')
