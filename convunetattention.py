...
def get_unet():
    with tf.device('/device:GPU:0'):
        ...
        conv1 = Conv2D(32, (3,3), padding='same', kernel_initializer='he_normal', name='conv1_1')(inputs)
        ...
        conv2 = Conv2D(96, (3,3), padding='same', kernel_initializer='he_normal', name='conv2_1')(pool1)
        ...
        conv3 = Conv2D(160, (3,3), padding='same', kernel_initializer='he_normal', name='conv3_1')(pool2)
        ...
        conv4 = Conv2D(224, (3,3), padding='same', kernel_initializer='he_normal', name='conv4_1')(pool3)
        conv4 = BatchNormalization(name='BN4_1')(conv4)
        conv4 = Activation('relu', name ='Activation4_1')(conv4)
        conv4 = Conv2D(256, (3,3), activation='relu', padding='same', kernel_initializer='he_normal', name='conv4_2')(conv4)
        ...
        conv5 = Conv2D(384, (3,3), padding='same', kernel_initializer='he_normal', name='conv5_1')(pool4)
    ...
    with tf.device('/device:GPU:1'):
        ...
        up7 = Conv2D(192, (3,3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name='conv7_1')(UpSampling2D(size = (2,2), name='Up2')(conv6))
        merge7 = keras.layers.Concatenate(name='concat2')([conv3, up7])
        conv7 = Conv2D(160, (3,3), padding='same', kernel_initializer='he_normal', name='conv7_2')(merge7)
        conv7 = BatchNormalization(name='BN7_1')(conv7)
        conv7 = Activation('relu', name ='Activation7_1')(conv7)
        conv7 = Conv2D(128, (3,3), padding='same', kernel_initializer='he_normal', name='conv7_3')(conv7)
        conv7 = BatchNormalization(name='BN7_2')(conv7)
        conv7 = Activation('relu', name ='Activation7_2')(conv7)
    
        up8 = Conv2D(96, (3,3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name='conv8_1')(UpSampling2D(size = (2,2), name='Up3')(conv7))
        merge8 = keras.layers.Concatenate(name='concat3')([conv2, up8])
        conv8 = Conv2D(64, (3,3), padding='same', kernel_initializer='he_normal', name='conv8_2')(merge8)
        conv8 = BatchNormalization(name='BN8_1')(conv8)
        conv8 = Activation('relu', name ='Activation8_1')(conv8)
        conv8 = Conv2D(48, (3,3), padding='same', kernel_initializer='he_normal', name='conv8_3')(conv8)
        conv8 = BatchNormalization(name='BN8_2')(conv8)
        conv8 = Activation('relu', name ='Activation8_2')(conv8)
    
        up9 = Conv2D(32, (3,3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name='conv9_1')(UpSampling2D(size = (2,2), name='Up4')(conv8))
        merge9 = keras.layers.Concatenate(name='concat4')([conv1, up9])
        conv9 = Conv2D(16, (3,3), padding='same', kernel_initializer='he_normal', name='conv9_2')(merge9)
        conv9 = BatchNormalization(name='BN9_1')(conv9)
        conv9 = Activation('relu', name ='Activation9_1')(conv9)
        conv9 = Conv2D(8, (3,3), padding='same', kernel_initializer='he_normal', name='conv9_3')(conv9)
...
model.save('final_attention_justconv.h5')
...
plt.savefig('lossAutoencoderjustconv.png')
...
plt.savefig('dice_coef_autoEncoderjustconv.png')
...
plt.savefig('jaccard_coef_autoEncoderjustconv.png')

plt.figure(3)
plt.plot(history.history['lr'])
plt.title('Learning Rate')
plt.xlabel('epoch')
plt.savefig('lr_autoencoderjustconv.png')