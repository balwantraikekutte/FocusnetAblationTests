...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 27 18:29:42 2018
...
block2concat = keras.layers.Multiply()([se2, gate2])
...
block3concat = keras.layers.Multiply()([se3, gate3])
...
callbacks = [
    ...
    ModelCheckpoint("sureshresnete2e_val_loss_bottleneck_ldmk9_checkpoint.h5", monitor='val_loss', verbose=1, save_best_only=True, mode='auto'),
...
model.save('sureshresnete2e_bottleneck_ldmk9_model.h5')
...
plt.savefig('sureshe2e_ldmk_loss.png')

plt.figure(1)
plt.plot(history.history['lr'])
plt.title('Learning Rate')
plt.xlabel('epoch')
plt.savefig('sureshe2e_ldmk_lr.png')
...
plt.savefig('sureshe2e_ldmk9_metric.png')
