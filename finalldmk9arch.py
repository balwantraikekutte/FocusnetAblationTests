...
callbacks = [
    ...
    ModelCheckpoint("resnet_val_loss_bottleneck_ldmk9_checkpoint.h5", monitor='val_loss', verbose=1, save_best_only=True, mode='auto'),
...
model.save('resnet_bottleneck_ldmk9_model.h5')
