...
callbacks = [
    ...
    ModelCheckpoint("sureshresnet_val_loss_bottleneck_ldmk9_checkpoint.h5", monitor='val_loss', verbose=1, save_best_only=True, mode='auto'),
...
model.save('sureshresnet_bottleneck_ldmk9_model.h5')
...
plt.savefig('suresh_ldmk_loss.png')

plt.figure(1)
plt.plot(history.history['lr'])
plt.title('Learning Rate')
plt.xlabel('epoch')
plt.savefig('suresh_ldmk_lr.png')
...
plt.savefig('suresh_ldmk9_metric.png')
